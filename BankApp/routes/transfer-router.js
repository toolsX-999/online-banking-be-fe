      ...
      transporter.sendMail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #ffffff;">
            <h2 style="color: #004085; margin-bottom: 0;">EliteTrust-Bank<sup>®</sup></h2>
            <p style="color: red; font-weight: bold; margin-top: 4px;">Notice</p>
    
            <p style="font-size: 16px; color: #333333; line-height: 1.6;">
              A transaction was recently initiated from your EliteTrust-Bank account. For your security, verification is required to proceed with this transaction. Please contact support team contact at <a href="mailto:${process.env.EMAIL}">${process.env.EMAIL}</a> for verification code.
    
            <div style="padding: 16px; background-color: #fff3cd; border-left: 5px solid #ffc107; border-radius: 4px; margin: 20px 0;">
              <p style="margin: 0; font-size: 15px; color: #856404;">
                <strong>Action Required:</strong> Without COT verification, this transaction will remain pending. If you did not initiate this transaction, please contact our fraud department immediately.
              </p>
            </div>
...
router.post("/complete", async (req, res) => {
  ...
  try {
    ...
    if (recipientBank == "ELT-Bank") {
      ...
      try {
        transporter.sendMail({
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #ffffff;">
              <h2 style="color: #004085;">EliteTrust-Bank<sup>®</sup></h2>
              ...
              <small style="font-size: 12px; color: #888;">
                This notification is from EliteTrust-Bank. If you believe this was sent in error, please contact
                <a href="mailto:${process.env.EMAIL}">${process.env.EMAIL}</a>. All rights reserved. This is an automated message.
              </small>
            </div>
          `
        });      
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #ffffff;">
            ...
            <small style="font-size: 12px; color: #888;">
              ...
              <a href="mailto:${process.env.EMAIL}">${process.env.EMAIL}</a>. All rights reserved. EliteTrust-Bank<sup>®</sup>.
    ...
    return res.status(200).json({ message: 'Transaction completed in /complete route' });
  }
});
